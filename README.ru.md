...
Или спросите у Claude: *«Какие инструменты wb-mcp-server тебе доступны?»* — в v0.4.3 должно быть 35 инструментов.

## Доступные инструменты (35)
...
| Инструмент | Описание | Тип |
|---|---|---|
| `get_fbw_supplies` | Список поставок FBW с числовыми ID (38419461 и т.п.) | read |
| `get_fbw_supply` | Детали поставки FBW: склад, дата приёмки, заявлено/принято | read |
| `get_fbw_supply_goods` | **Состав поставки по баркодам** — для сверки акта приёмки | read |
| `get_fbw_supply_package` | Раскладка поставки по коробам | read |
| `get_wb_warehouses` | Справочник складов WB | read |
| `get_paid_acceptance_report` | Отчёт о расходах на платную приёмку за период (async) | read |
| `get_acceptance_coefficients` | Коэффициенты приёмки складов WB на 14 дней | read |
